...
class InfoDdrIO extends Bundle {
  val dataOut = Output(Vec(6, UInt(32.W)))
...
class Information extends Module {
  ...
  threeMThree.io.A := io.fromRegfile.readData(4)(21, 19)
  threeMThree.io.B := io.fromRegfile.readData(4)(21, 19)
  ...
  sixMEleven.io.B := io.fromRegfile.readData(4)(10, 0)
  ...
  seventeenMEleven.io.B := io.fromRegfile.readData(3)(10, 0)
  seventeenMEleven.io.CE := validDelay(1)
  validDelay(2) := validDelay(1)

  // 8 * 8
  eightMEight(0).CLK := clock
  eightMEight(0).A := io.fromRegfile.readData(3)(18, 11)
  eightMEight(0).B := io.fromRegfile.readData(3)(18, 11)
  eightMEight(0).CE := io.fromFsm.infoEn

  eightMEight(1).CLK := clock
  eightMEight(1).A := io.fromRegfile.readData(4)(18, 11)
  eightMEight(1).B := io.fromRegfile.readData(4)(18, 11)
  eightMEight(1).CE := io.fromFsm.infoEn

  // 16 * 11
  sixteenMEleven(0).CLK := clock
  sixteenMEleven(0).A := eightMEight(0).P
  sixteenMEleven(0).B := io.fromRegfile.readData(3)(10, 0)
  sixteenMEleven(0).CE := validDelay(0)

  sixteenMEleven(1).CLK := clock
  sixteenMEleven(1).A := eightMEight(1).P
  sixteenMEleven(1).B := io.fromRegfile.readData(4)(10, 0)
  ...
  io.toDdrC.dataOut(3) := sixteenMEleven(0).P
  io.toDdrC.dataOut(4) := sixteenMEleven(1).P
  io.toDdrC.dataOut(5) := seventeenMEleven.io.P
}